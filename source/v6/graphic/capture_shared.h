...
#define HLSL_OCTREE_FIRST_CHILD_OFFSET_SLOT			5
#define HLSL_OCTREE_LEAF_SLOT						6
#define HLSL_OCTREE_INDIRECT_ARGS_SLOT				7
#define HLSL_BLOCK_POS_SLOT							8
#define HLSL_BLOCK_DATA_SLOT						9
#define HLSL_BLOCK_INDIRECT_ARGS_SLOT				10
